// admin/src/components/GoogleAuthenticatorLogo.jsx

/**
 * The Google Authenticator mark (the April 2023 refresh), inlined for the same
 * reason as GmailLogo: a modal asking for a second factor has to render even
 * when the network is the thing that's broken.
 *
 * Source: Wikimedia Commons, "Google_Authenticator_(April_2023).svg" — Google,
 * public domain. The paths are upstream's, unedited.
 */
export default function GoogleAuthenticatorLogo({ className = "" }) {
  return (
    <svg
      viewBox="0 0 512 512"
      className={className}
